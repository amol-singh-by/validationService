...
SERVICE_DEF_PATH = os.path.join(os.path.dirname(__file__), '../config-repo/lpa/resources/config/LPA-2021.1.0.yaml')
WORKFLOW_CFG_PATH = os.path.join(os.path.dirname(__file__), '../config-repo/lpa/resources/config/workflowConfig.json')
TRANSFORM_CFG_PATH = os.path.join(os.path.dirname(__file__), '../config-repo/lpa/resources/config/transformConfig.json')
